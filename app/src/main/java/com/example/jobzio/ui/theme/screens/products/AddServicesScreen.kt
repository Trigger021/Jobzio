package com.example.jobzio.ui.theme.screens.products
...
import com.example.jobzio.data.ProductViewModel
...
fun AddServicesScreenPreview(){
    JobZioTheme {
        AddServicesScreen(navController = rememberNavController())
    }
}